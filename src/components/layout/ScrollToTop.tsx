...
const ScrollToTop = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={cn(
        "fixed bottom-8 right-8 z-[100] p-4 rounded-full bg-gold/90 text-background shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 group border border-white/20",
